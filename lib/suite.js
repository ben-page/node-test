...
function makeInstance() {
    ...
    Suite.prototype[addTest] = function(name, action, failHandler, options, stackStartFunction) {
        ...
        this[tests].push(new Test(this, name, action, failHandler, options, util.getStackTrace(stackStartFunction)));
    ...
    Suite.prototype.before = function (action) {
        ...
        this[before] = new Hook(this, action, true, util.getStackTrace(Suite.prototype.before));
        return this;
    };
    ...
    Suite.prototype.after = function (action) {
        ...
        this[after] = new Hook(this, action, true, util.getStackTrace(Suite.prototype.after));
        return this;
    };
    ...
    Suite.prototype.beforeEach = function (action) {
        ...
        this[beforeEach] = new Hook(this, action, false, util.getStackTrace(Suite.prototype.beforeEach));
        return this;
    };
    ...
    Suite.prototype.afterEach = function (action) {
        ...
        this[afterEach] = new Hook(this, action, false, util.getStackTrace(Suite.prototype.afterEach));
        return this;
    };
    
    Suite.prototype[run] = async function () {
        this[ran] = true;
