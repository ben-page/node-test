...
module.exports = class Assert {
    ...
    fail(message) {
        if (message !== undefined && typeof message !== 'string')
            shared.throwError('argument 1 \'message\' should be a string', Assert.prototype.fail);
        performTest(false, message || 'failed', Assert.prototype.fail);
    }

    true(value, message) {
        if (typeof value !== 'boolean')
            shared.throwError('argument 1 \'value\' should be a boolean', Assert.prototype.true);
        if (message !== undefined && typeof message !== 'string')
            shared.throwError('argument 2 \'message\' should be a string', Assert.prototype.true);
        performTest(value === true, message, Assert.prototype.true, value, true, '===');
    }

    false(value, message) {
        if (typeof value !== 'boolean')
            shared.throwError('argument 1 \'value\' should be a boolean', Assert.prototype.false);
        if (message !== undefined && typeof message !== 'string')
            shared.throwError('argument 2 \'message\' should be a string', Assert.prototype.false);
        performTest(value === false, message, Assert.prototype.false, value, false, '===');
    };

    truthy(value, message) {
        if (message !== undefined && typeof message !== 'string')
            shared.throwError('argument 2 \'message\' should be a string', Assert.prototype.truthy);
        performTest(value, message, Assert.prototype.truthy, value, true, '==');
    }

    assert(value, message) {
        if (message !== undefined && typeof message !== 'string')
            shared.throwError('argument 2 \'message\' should be a string', Assert.prototype.assert);
        performTest(value, message, Assert.prototype.assert, value, true, '==');
    }

    falsey(value, message) {
        if (message !== undefined && typeof message !== 'string')
            shared.throwError('argument 2 \'message\' should be a string', Assert.prototype.falsey);
        performTest(!value, message, Assert.prototype.falsey, value, false, '==');
    }

    equal(value, expected, message) {
        if (message !== undefined && typeof message !== 'string')
            shared.throwError('argument 3 \'message\' should be a string', Assert.prototype.equal);
        performTest(value === expected, message, Assert.prototype.equal, value, expected, '===');
    }

    equals(value, expected, message) {
        if (message !== undefined && typeof message !== 'string')
            shared.throwError('argument 3 \'message\' should be a string', Assert.prototype.equals);
        performTest(value === expected, message, Assert.prototype.equals, value, expected, '===');
    }

    is(value, expected, message) {
        if (message !== undefined && typeof message !== 'string')
            shared.throwError('argument 3 \'message\' should be a string', Assert.prototype.is);
        performTest(value === expected, message, Assert.prototype.is, value, expected, '===');
    }

    notEqual(value, expected, message) {
        if (message !== undefined && typeof message !== 'string')
            shared.throwError('argument 3 \'message\' should be a string', Assert.prototype.notEqual);
        performTest(value !== expected, message, Assert.prototype.notEqual, value, expected, '!==');
    }

    not(value, expected, message) {
        if (message !== undefined && typeof message !== 'string')
            shared.throwError('argument 3 \'message\' should be a string', Assert.prototype.not);
        performTest(value !== expected, message, Assert.prototype.not, value, expected, '!==');
    }

    notEquals(value, expected, message) {
        if (message !== undefined && typeof message !== 'string')
            shared.throwError('argument 3 \'message\' should be a string', Assert.prototype.notEquals);
        performTest(value !== expected, message, Assert.prototype.notEquals, value, expected, '!==');
    }

    deepEqual(value, expected, message) {
        if (message !== undefined && typeof message !== 'string')
            shared.throwError('argument 3 \'message\' should be a string', Assert.prototype.deepEqual);
        performTest(notSoShallow(value, expected), message, Assert.prototype.deepEqual, value, expected, 'deepEqual');
    }

    notDeepEqual(value, expected, message) {
        if (message !== undefined && typeof message !== 'string')
            shared.throwError('argument 3 \'message\' should be a string', Assert.prototype.notDeepEqual);
    ...
    greaterThan(value, expected, message) {
        if (message !== undefined && typeof message !== 'string')
            shared.throwError('argument 3 \'message\' should be a string', Assert.prototype.greaterThan);
        performTest(value > expected, message, Assert.prototype.deepEqual, value, expected, '>');
    }

    greaterThanOrEqual(value, expected, message) {
        if (message !== undefined && typeof message !== 'string')
            shared.throwError('argument 3 \'message\' should be a string', Assert.prototype.greaterThanOrEqual);
        performTest(value >= expected, message, Assert.prototype.greaterThanOrEqual, value, expected, '>=');
    }

    lessThan(value, expected, message) {
        if (message !== undefined && typeof message !== 'string')
            shared.throwError('argument 3 \'message\' should be a string', Assert.prototype.lessThan);
        performTest(value < expected, message, Assert.prototype.deepEqual, value, expected, '<');
    }

    lessThanOrEqual(value, expected, message) {
        if (message !== undefined && typeof message !== 'string')
            shared.throwError('argument 3 \'message\' should be a string', Assert.prototype.lessThanOrEqual);
        performTest(value <= expected, message, Assert.prototype.lessThanOrEqual, value, expected, '<=');
    }

    noError(value, message) {
        if (message !== undefined && typeof message !== 'string')
            shared.throwError('argument 2 \'message\' should be a string', Assert.prototype.noError);
        performTest(!value, message, Assert.prototype.noError, value, 'Error', '!==');
    }

    async throws(fn, arg) {
        if (typeof fn !== 'function')
            shared.throwError('argument 1 \'fn\' should be a function', Assert.prototype.throws);

        if (fn.length > 1)
            shared.throwError('argument 1 \'fn\' should be a function with 0 or 1 argument', Assert.prototype.throws);
        ...
        switch (typeof arg) {
            ...
            case 'undefined':
                break;
            default:
                shared.throwError('argument 2 should be a function or string', Assert.prototype.throws);
        }
    ...
    notThrows(fn, ...args) {
        if (typeof fn !== 'function')
            shared.throwError('argument 1 \'fn\' should be a function', Assert.prototype.notThrows);

        if (fn.length === 0)
            shared.throwError('argument 1 \'fn\' should have at least 1 argument', Assert.prototype.notThrows);
    ...
    toPromise(fn, ...args) {
        ...
        return this[test].constructor.runAsync(fn, args);
    }
    ...
    async(...args) {
        ...
        if (args.length < 0 || args.length > 2)
            shared.throwError('expected between 0 and 2 arguments', Assert.prototype.async);
        ...
        if (args.length >= 1) {
            switch (typeof args[0]) {
                ...
                case 'number':
                    ...
                    break;
                default:
                    shared.throwError('argument 1 should be a function or number', Assert.prototype.async);
            }

            if (args.length === 2) {
                if (fn === undefined)
                    shared.throwError('unexpected argument 2', Assert.prototype.async);

                count = args[1];
                if (typeof count !== 'number' || count <= 0 || parseInt(count) !== count)
                    shared.throwError('argument 2 \'count\' should be a whole number greater than 0', Assert.prototype.async);
            }
        }
        ...
        const callback = (...args2) => {
            ...
            if (fulfilled)
                shared.throwError('callback executed after test completed', Assert.prototype.async);
